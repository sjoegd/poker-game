  ...
  return (
    <TableContainer>
      ...
      <HandContainer row={2} column={3} rotate={270}>
        ...
        />
        <CoinStackContainer> {/* fix z-indexes*/}
          <CoinStack rotate={-270} amount={2} color={'black'} />
          <CoinStack rotate={-270} amount={4} color={'darkred'} />
          <CoinStack rotate={-270} amount={5} color={'darkblue'} />
          <CoinStack rotate={-270} amount={5} color={'darkgreen'} />
        </CoinStackContainer>
      </HandContainer>
